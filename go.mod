...
replace (
	github.com/argoproj/pkg => github.com/atlassian-forks/argo-pkg v0.0.0-20231227045722-3ec2b7a3ae0b
	github.com/argoproj/pkg/s3 => github.com/atlassian-forks/argo-pkg/s3 v0.0.0-20231227045722-3ec2b7a3ae0b
)
